...
ADD run.sh /root/
RUN mkdir /root/cf_nise_installer/test_apps && mkdir /root/cf_nise_installer/test_apps/spring-music && mkdir /root/cf_nise_installer/test_apps/cf-env && mv /root/cf_nise_installer/test_app /root/cf_nise_installer/test_apps/ && mv /root/cf_nise_installer/test_app /root/cf_nise_installer/test_app /root/cf_nise_installer/test_app /root/cf_nise_installer/test_apps/
