...
echo "\naddress=/$NISE_DOMAIN/127.0.0.1" >> /etc/dnsmasq.conf
echo 'sed -i "s/${NISE_IP_ADDRESS}/127.0.0.1/g" manifests/deploy.yml' >> /root/cf_nise_installer/scripts/generate_deploy_manifest.sh
